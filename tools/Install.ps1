...
"*********** Adding SideWaffle" | Write-Host

$importLabel = "SideWaffleVsix"
$targetsPropertyName = "SideWaffleVsixTargets"
$targetsFileToAddImport = "ligershark.vstemplates.targets";
...
$propNuGetImportPath.Condition = ' ''$(SideWaffleVsixTargets)''=='''' ';

AddImportElementIfNotExists -projectRootElement $projectMSBuild

$projectMSBuild.Save()

"    SideWaffle has been installed into project [{0}]" -f $project.FullName| Write-Host -ForegroundColor DarkGreen
